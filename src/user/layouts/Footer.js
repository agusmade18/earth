        ...
        <footer className="text-center lg:text-left bg-gray-800 text-white">
            ...
            <div className="mx-6 py-10 text-center md:text-left">
                ...
                <div className="">
                    ...
                    <p>
                    {process.env.REACT_APP_COMPANYDESCRIPTION}
                    </p>
                </div>
                {/* <div className="">
                ...
                <div className="">
                    ...
                    {process.env.REACT_APP_COMPANYPHONE}
                    </p>
                    ...
                    {process.env.REACT_APP_COMPANYFAX}
                    </p>
                </div>
                </div>
            </div>
            <div className="text-center p-6 bg-gray-200 text-gray-800">
                <span>© 2022 Copyright:</span>
                <a className="text-gray-600 font-semibold" href="https://facebook.com/newbieagus">AgusMade</a>
            </div>
            </footer>
    </React.Fragment>
  )
